<%@ Page Title="" Language="C#" MasterPageFile="~/ADMIN/Admin.master" AutoEventWireup="true" CodeFile="package_catagory.aspx.cs" Inherits="ADMIN_Default2" %>
	...
	td:before { 
     ...
     <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Package Catagory Details
            <small>Control panel</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">  Package Catagory Details</li>
          </ol>
        </section>
           ...
           <!-- <form action="/action_page.php" style="max-width:500px;margin:auto"> -->
            <form id="Form1" runat="server">
              <div class="container" style="text-align: center;max-height:100%">
                <h1>  Package Catagory Details</h1>
                <!-- <p>Please fill in this form to create an account.</p> -->
                <hr>

              

                <label for="email" style="margin-right: 490px;" ><b>package Name</b></label><br>
              <%--  <input type="text"  placeholder="City Name" name="email" id="email" required><br>--%>
                  <asp:TextBox ID="TextBox2" runat="server" placeholder="Enter Hotel No" name="email"></asp:TextBox><br />
            ...
            --%><%--<asp:TextBox ID="TextBox1" runat="server" placeholder="Enter Hotel No" name="email"></asp:TextBox><br /--%>
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:connectionstring1 %>" DeleteCommand="DELETE FROM [p_c] WHERE [Id] = @original_Id AND [sub_category] = @original_sub_category AND [status] = @original_status" InsertCommand="INSERT INTO [p_c] ([sub_category], [status]) VALUES (@sub_category, @status)" OldValuesParameterFormatString="original_{0}" ProviderName="<%$ ConnectionStrings:connectionstring1.ProviderName %>" SelectCommand="SELECT * FROM [p_c]" UpdateCommand="UPDATE [p_c] SET [sub_category] = @sub_category, [status] = @status WHERE [Id] = @original_Id AND [sub_category] = @original_sub_category AND [status] = @original_status">
                      <DeleteParameters>
