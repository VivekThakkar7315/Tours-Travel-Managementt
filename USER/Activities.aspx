<%@ Page Title="" Language="C#" MasterPageFile="~/USER/User.master" AutoEventWireup="true" CodeFile="Activities.aspx.cs" Inherits="SEM_6_FINAL_PROJECT_USER_Default" %>
			...
			<div class="row">
				...
				<div class="col-lg-11">
					<div class="col text-center">
						<h2 class="section_title">we have the best activities</h2>
					</div>
					<!-- Offers Sorting -->
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										...
										<%--<div class="offers_image_background">
                                            <img src='../ADMIN/upload/<%#Eval("photo") %>' alt=""/>
										</div>--%>
										<div class="offer_name"><a href="single_listing.html"><%#Eval("activity_name") %></a></div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										<div class="offers_price"><%#Eval("activity_name") %></div>
										...
										<p class="offers_text"><%#Eval("activity_description") %> </p><br />
                                       <%-- <p class="offers_text"><%#Eval("activity_requirment") %> </p>--%>
                            <%--              <p class="offers_text"><%#Eval("activity_place") %> </p>--%>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:connectionstring1 %>" ProviderName="<%$ ConnectionStrings:connectionstring1.ProviderName %>" SelectCommand="SELECT * FROM [activity] WHERE (([actvity_place] = @actvity_place) AND ([status] = @status))">
                    <SelectParameters>
                        <asp:SessionParameter Name="actvity_place" SessionField="city" Type="String" />
