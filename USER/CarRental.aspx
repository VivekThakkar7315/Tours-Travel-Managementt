<%@ Page Title="" Language="C#" MasterPageFile="~/USER/User.master" AutoEventWireup="true" CodeFile="CarRental.aspx.cs" Inherits="SEM_6_FINAL_PROJECT_USER_Default" %>
			...
			<div class="row">
				...
				<div class="col-lg-11">
					<div class="col text-center">
						<h2 class="section_title">we have the best cars for you</h2>
					</div>					
				</div>
							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offers_image_background" style="background-image:url(../ADMIN/upload/<%#Eval("car_photo") %>)"></div>
										<%--<div class="offer_name"><a href="single_listing.html">zip line</a></div>--%>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										<div class="offers_price"><%#Eval("shop_name") %></div>
										...
										<div class="offers_distance">Contact No:<span><%#Eval("mobile_no") %></span></div>
										<p class="offers_text">Alongside the basic rental of a vehicle, car rental agencies typically also offer extra products such as insurance, global positioning system (GPS) navigation systems, entertainment systems, mobile phones, portable WiFi and child safety seats.  </p>
