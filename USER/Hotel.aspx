<%@ Page Title="" Language="C#" MasterPageFile="~/USER/User.master" AutoEventWireup="true" CodeFile="Hotel.aspx.cs" Inherits="USER_Default" %>
      ...
      <link rel="stylesheet" type="text/css" href="styles/offers_responsive.css">
		...
		<div class="container">
			...
			<div class="row">
							...
							<div class="row">
								...
								<div class="col-lg-3 col-1680-4">
									<div class="offers_image_container">
										...
										<div class="offer_name"><a href="single_listing.html"><%#Eval("hotel_name") %></a></div>
									</div>
								</div>
								<div class="col-lg-8">
									<div class="offers_content">
										<div class="offers_price">₹<%#Eval("price_per_night") %><span>per night</span></div>
										...
										<p class="offers_text"><%#Eval("hotel_description") %>  </p>
										<p class="offers_text">25% off for your first booking      </p>
										...
										<div class="button book_button"><a href="hotelbook.aspx?id=<%#Eval("id") %>" >book</a></div>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:connectionstring1 %>" ProviderName="<%$ ConnectionStrings:connectionstring1.ProviderName %>" SelectCommand="SELECT * FROM [hotel] WHERE (([city] = @city) AND ([status] = @status))">
                    <SelectParameters>
                        <asp:SessionParameter Name="city" SessionField="city" Type="String" />
                        <asp:SessionParameter SessionField="city" Name="city2" Type="String"></asp:SessionParameter>
