<%@ Page Language="C#" AutoEventWireup="true" CodeFile="blog1.aspx.cs" Inherits="USER_blog1" %>
					...
					<div class="blog_post_container">
						...
						<div class="blog_post">
							<div class="blog_post_image">
								<img src="images/b3.jpg" alt="https://unsplash.com/@anniespratt">
								<div class="blog_post_date d-flex flex-column align-items-center justify-content-center">
									<div class="blog_post_day">01</div>
									<div class="blog_post_month">Dec, 2021</div>
								</div>
							</div>
							<div class="blog_post_meta">
								<ul>
									<li class="blog_post_meta_item"><a href="#">by salman khan</a></li>
							...
							<div class="blog_post_text">
								<p>Update 2021: Due to how popular this article has become, I have decided to keep this article alive and will continue to add more beautiful travel blogs as I discover it.</p>
								<p>Tips: Did you know that you can start a travel blog for as low as 3 USD per month? If you are looking to start a travel blog and are looking to save some cost, I highly recommend you check out</p>
							</div>
						...
						<div class="blog_post">
							<div class="blog_post_image">
								<img src="images/blog1.jpeg" alt="https://unsplash.com/@tschax">
								<div class="blog_post_date d-flex flex-column align-items-center justify-content-center">
									<div class="blog_post_day">01</div>
									<div class="blog_post_month">july, 2021</div>
								</div>
							</div>
							<div class="blog_post_meta">
								<ul>
									<li class="blog_post_meta_item"><a href="">by amir khan</a></li>
									<li class="blog_post_meta_item"><a href="">Uncategorized</a></li>
									<li class="blog_post_meta_item"><a href="">3 Comments</a></li>
								</ul>
							</div>
							<div class="blog_post_title"><a href="#">happiness in this destination</a></div>
							<div class="blog_post_text">
								<p>What I love about it: The Travel Episodes does not just take storytelling to the next level with their writings but also with video clips, sound effects, and photography. It's like reading a futuristic storybook that teleported you to the place.</p>
								<p> the Hitchhiking through himachal entry, when you first landed on the page, you are already feeling the tense atmosphere of the video playing in the background, and the more you read through easily-digestible paragraphs, the more you want to see how it all went down. The Travel Episodes blog takes travel blogging into the realm of short stories like no other travel blogs I have seen.</p>
							</div>
							<div class="blog_post_link"><a href="#">read more</a></div>
						</div>
						...
						<div class="blog_post">
							<div class="blog_post_image">
								<img src="images/b2.jpg" alt="https://unsplash.com/@stilclassics">
								<div class="blog_post_date d-flex flex-column align-items-center justify-content-center">
									<div class="blog_post_day">01</div>
									<div class="blog_post_month">jan, 2022</div>
								</div>
							</div>
							<div class="blog_post_meta">
								<ul>
									<li class="blog_post_meta_item"><a href="">by sharkha khan</a></li>
									<li class="blog_post_meta_item"><a href="">Uncategorized</a></li>
									<li class="blog_post_meta_item"><a href="">3 Comments</a></li>
								</ul>
							</div>
							<div class="blog_post_title"><a href="#">Heaven in this world</a></div>
							<div class="blog_post_text">
								<p>At the end of 2020, I wrote about trying to recover what I called “the lost year” — the year in which I got COVID, saw all my businesses collapse, took out tons of loans to avoid bankruptcy, and, like everyone, had to put all my life plans (settling down, buying a house, joining some social clubs, dating) on a seemingly endless hold.</p>
							    <p>As the year wound to a close, I needed a mental break, so I went to Mexico with friends, with a plan to rent a house and stay in the Tulum/Playa area. Over the next seven weeks, I fell in love with the country and, specifically, Oaxaca. (Tulum sucked so we left.)</p>
 							</div>
							<div class="blog_post_link"><a href="#">read more</a></div>
						</div>
							...
							<ul>
								...
								<li class="latest_post clearfix">
									...
									<div class="latest_post_content">
										...
										<div class="latest_post_meta">
											<div class="latest_post_author trans_200"><a href="#">by carryminati</a></div>
											<div class="latest_post_date trans_200"><a href="#">Aug 25, 2021</a></div>
										</div>
									</div>
								</li>
								...
								<li class="latest_post clearfix">
									...
									<div class="latest_post_content">
										...
										<div class="latest_post_meta">
											<div class="latest_post_author trans_200"><a href="#">by vivek thakkar</a></div>
											<div class="latest_post_date trans_200"><a href="#">feb 13, 2021</a></div>
										</div>
									</div>
								</li>
								...
								<li class="latest_post clearfix">
									...
									<div class="latest_post_content">
										...
										<div class="latest_post_meta">
											<div class="latest_post_author trans_200"><a href="#">by rahul rana</a></div>
											<div class="latest_post_date trans_200"><a href="#">nov 24, 2020</a></div>
										</div>
									</div>
								</li>
								...
								<li class="latest_post clearfix">
									...
									<div class="latest_post_content">
										...
										<div class="latest_post_meta">
											<div class="latest_post_author trans_200"><a href="#">by moiz siamvala</a></div>
											<div class="latest_post_date trans_200"><a href="#"> may 31, 2021</a></div>
										</div>
									</div>
								</li>
