<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contact1.aspx.cs" Inherits="USER_contact1" %>
				...
				<div class="col">
					...
					<div class="contact_form_container">
						...
						<form action="#" id="contact_form" class="contact_form text-center">
                            ...
                            <asp:TextBox ID="TextBox1"  class="contact_form_name input_field" placeholder="Name"  runat="server"></asp:TextBox>
							<%--<input type="text" id="contact_form_email" class="contact_form_email input_field" placeholder="E-mail" required="required" data-error="Email is required.">--%>
                             <asp:TextBox ID="TextBox2"  class="contact_form_name input_field" placeholder="Email"  runat="server"></asp:TextBox>
							<%--<input type="text" id="contact_form_subject" class="contact_form_subject input_field" placeholder="Subject" required="required" data-error="Subject is required.">--%>
                             <asp:TextBox ID="TextBox3"  class="contact_form_name input_field" placeholder="Your Query"  runat="server" TextMode="MultiLine"></asp:TextBox><br />
							...
							<%--<button type="submit" id="form_submit_button" class="form_submit_button button trans_200">send message<span></span><span></span><span></span></button>--%>
                             <asp:Button ID="Button1" align="center"  runat="server"  class="form_submit_button button trans_200" Text="Send Message" OnClick="Button1_Click" />
						</form>
			...
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<div class="about_content">
						...
						<p class="about_text">The Best Way To See Your Dreem Destination With Us. Our Best Service And Minmumm Charges .Any Place Of Indian and Any Other City We Have Provide Our Best Fesibility In Minimau Charges. Your Dream Is Our Responsibility. Achive Your Drem Destination With Join Us And Make Beutiful Moments And Capcherd This Moment With Us.  </p>
