<%@ Page Language="C#" AutoEventWireup="true" CodeFile="flightbook.aspx.cs" Inherits="SEM_6_PROJECT_USER_flightbook" %>
...
input[type=text],[type=range],[type=date],select {
  width: 100%;
  margin-bottom: 20px;
  padding: 12px;
...
<body style="background-color:cadetblue">
    <form runat="server">
<h2 align="center">Book Your Flight Now</h2>
...
<%--  <video width="600" controls>
  <source src="../ADMIN/upload/flight.mp4"  type="video/mp4">
