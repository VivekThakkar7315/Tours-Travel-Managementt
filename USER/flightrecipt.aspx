<%@ Page Language="C#" AutoEventWireup="true" CodeFile="flightrecipt.aspx.cs" Inherits="USER_flightrecipt" %>
           ...
           <tr>  <td align="center">     Contact :- (0261) 3446641 </td></tr></table>
              ...
              <table style="width: 100%; margin-bottom: 30px;" align="center" border="1">
                 <tr style="background-color:lightblue">
                    ...
                    <td class="auto-style4" align="center">Email Id  </td>
                      <td class="auto-style6" align="center">Address  </td>
                       ...
                       <td class="auto-style10" align="center">Compay Name </td>
                     <td class="auto-style10" align="center">From </td>
                     </tr>
                   <tr>
                     ...
                     <td class="auto-style5" align="center"><asp:Label ID="L4" runat="server" Text="Label"></asp:Label></td>
                      <td class="auto-style5" align="center"><asp:Label ID="L5" runat="server" Text="Label"></asp:Label></td>
                        <td class="auto-style5" align="center"><asp:Label ID="L13" runat="server" Text="Label"></asp:Label></td>
                </tr>
                  
                  <tr style="background-color:lightblue">
                     
                      <td class="auto-style10" align="center">To</td>
                      <td class="auto-style10" align="center">Tack Off Time </td>
                      <td class="auto-style10" align="center">Landing Time  </td>
                        <td class="auto-style12" align="center">Duration</td>
                     <td class="auto-style14" align="center">Class </td>
                      <td class="auto-style14" align="center">price </td>
                 ...
                 <tr>
                        ...
                        <td class="auto-style5" align="center"><asp:Label ID="L10" runat="server" Text="Label"></asp:Label></td> 
                      <td class="auto-style5" align="center"><asp:Label ID="L14" runat="server" Text="Label"></asp:Label></td> 
                      <td class="auto-style5" align="center"><asp:Label ID="L15" runat="server" Text="Label"></asp:Label></td> 
                      <td class="auto-style5" align="center"><asp:Label ID="L16" runat="server" Text="Label"></asp:Label></td> 
                 </tr>
