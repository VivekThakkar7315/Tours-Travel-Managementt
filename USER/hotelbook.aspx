<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hotelbook.aspx.cs" Inherits="USER_Book" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
      ...
      <script src = "jsfiles/html2canvas.min.js"></script>
        ...
        <script type="text/javascript">
            function Export() {
                alert("Hello")
                html2canvas(document.getElementById('Package bill'), {
                    onrendered: function (canvas) {
                        ...
                        pdfmake.createpdf(docDefinition).download("Package bill");
                        alert(" Package Bill Dowload is Statting");
                    }
                });
...
<body style="background-color:cadetblue">
    <form runat="server">
	<h2 align="center">Book Your Hotel Now</h2>
			...
			<div class="row">
				<div class="col-50">
                    ...
                    <asp:TextBox ID="contact" runat="server"></asp:TextBox>
							...
							<label for="city"><i class="fa fa-institution"></i> Check In</label>
                    <asp:TextBox ID="check_in" runat="server" type="date"></asp:TextBox>


                    <label for="city"><i class="fa fa-institution"></i> Check Out</label>
                    <asp:TextBox ID="check_out" runat="server" type="date"></asp:TextBox>
...
<label for="city"><i class="fa fa-institution"></i>Person </label>
  ...
  <source src="../ADMIN/upload/hotel.mp4"  type="video/mp4">
