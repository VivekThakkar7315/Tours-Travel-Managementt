<%@ Page Language="C#" AutoEventWireup="true" CodeFile="triprecept.aspx.cs" Inherits="USER_Default" EnableEventValidation="false" %>
                 ...
                 <tr style="background-color:lightblue">
                    ...
                    <td class="auto-style4" align="center">Email Id  </td>
                      <td class="auto-style6" align="center">Address  </td>
                       ...
                       <td class="auto-style10" align="center">Trip Stating Date </td>
                     </tr>
                   <tr>
                  ...
                  <tr style="background-color:lightblue">
                      ...
                      <td class="auto-style10" align="center">Trip Stating Place </td>
                      <td class="auto-style10" align="center">Trip Ending Place </td>
                      <td class="auto-style10" align="center">Trip Duration </td>
                        <td class="auto-style12" align="center">Person  </td>
...
<div align="center"><asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Dowload" BackColor="Black" BorderColor="White" BorderStyle="Double" Font-Size="Medium" ForeColor="White" Height="57px" Width="167px" /></div><br /><br /><div align="center"><asp:Button ID="Button2" runat="server" Text="Give FeedBack" BackColor="Black" BorderColor="White" BorderStyle="Double" Font-Size="Medium" ForeColor="White" Height="57px" Width="167px" OnClick="Button2_Click" /></div>
