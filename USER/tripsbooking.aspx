<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tripsbooking.aspx.cs" Inherits="USER_Default" %>
...
body {
  font-family: Arial;
  font-size: 17px;<a href="tripsbooking.aspx">tripsbooking.aspx</a>
  padding: 8px;
}
...
input[type=text],[type=date],[type=rang],select {
  width: 100%;
  margin-bottom: 20px;
  padding: 12px;
...
<body style="background-color:cadetblue">
	...
	<h2 align="center">Book Your Trip Now</h2>
	...
	<div class="container">
			...
			<div class="row" >
				<div class="col-50">
							...
							<label for="email" aria-readonly="True" hidden="hidden"><i class="fa fa-envelope"></i> Email</label>
...
<%--<video width="400" controls>
  <source src="../ADMIN/upload/road trip.mp4"  type="video/mp4">
  <source src="mov_bbb.ogg" type="video/ogg">
</video>--%>
        <asp:Button ID="Button1" class="btn" runat="server" Text="Book Now" OnClick="Button1_Click1"  />
